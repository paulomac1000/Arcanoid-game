...
void menu()
{
	sf::RenderWindow oknoMENU(sf::VideoMode(800, 600, 32), "Arkanoid by PABLO", 1); //fullscreen to 8, 1 to brak paska  u góry i nierozszerzalnoœæ
